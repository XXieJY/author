...
class Book extends Base {
    ...
    public function index(){
        ...
        //获取作者的书籍信息
        $book=Db::view('Book','book_id,contract_id,sign_id,book_name,upload_img,words,sign_id,audit')
 ...
 //获取作者积分
    ...
    public function save(){
      $author=$this->account;
       ...
       $con['book_name']=trim(html_entity_decode($data['bookName']));
...
//       }
    ...
    public function set($id){
       ...
       $shell= $this->shell($id);
        ...
        $book=Db::view('Book','book_id,book_name,book_brief,gender,weaving,level,upload_img,e_id,state,cp_id,keywords')
