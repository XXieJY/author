...
class Bang extends Controller{
   ...
   */
    ...
    public function jinzhu_total(){
        ...
        $sql="SELECT a.user_id, b.pen_name,portrait, SUM(a.money) AS money from shudong_user_consumerecord a LEFT  JOIN shudong_user b ON a.user_id=b.user_id  GROUP BY a.user_id  ORDER BY money DESC LIMIT 0,20";
        $info=Db::query($sql);
        if(!$info){
            return 1;
        }else{
